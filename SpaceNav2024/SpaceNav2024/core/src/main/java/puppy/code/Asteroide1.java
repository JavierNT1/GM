...
public class Asteroide1 {
    ...
    // Constructor privado para garantizar que solo se cree un objeto a través del Builder
    public Asteroide1(AsteroideBuilder builder) {
    ...
    // Getter de los atributos (si es necesario)
